...
V10_1_DIR = Path(__file__).parent / "models_v11" / "v10_1"
MODEL_PATH = V10_1_DIR / "boatrace_model_v10_1.pth"
SCALER_PATH = V10_1_DIR / "feature_scaler_v10_1.pkl"
...
def load_v10_1():
    ...
    # V10 の calibrators を流用（V10.1 は同じ NN アーキテクチャなので有効）
    calibrators = _load_calibrators()
    cal_status = "V10流用" if calibrators is not None else "なし"
    logger.info(f"V10.1 ロード: epoch={state['metadata']['epoch']} "
...
def evaluate_v10_1():
    ...
    out_path = REPORT_DIR / "09_v10_1_backtest.json"
